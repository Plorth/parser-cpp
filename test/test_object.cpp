...
static void test_eof_before_the_object()
{
...
static void test_no_brace_found()
{
...
static void test_unterminated_object()
{
  const auto result = parse(U"{");
...
static void test_unterminated_object_after_key()
{
...
static void test_unterminated_object_after_property()
{
...
static void test_unterminated_object_after_comma()
{
  const auto result = parse(U"{\"foo\": \"bar\",");
...
static void test_properties_without_comma()
{
